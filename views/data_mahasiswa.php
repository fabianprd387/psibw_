...
$all = mysqli_query($conn, "SELECT * FROM mahasiswa ORDER BY id DESC");
?>
<!doctype html>
<html>
    ...
    <div class="main-content" id="main-content">
      <div class="page-header">
        <div class="page-title">
          ...
          <p>Daftar lengkap mahasiswa terdaftar.</p>
        </div>
        <div class="main-actions">
          <a class="btn btn-add" href="add_mahasiswa.php">Tambah Mahasiswa</a>
        </div>
      </div>
      <div class="tables">
